...
#          browser.a(:text, "Login").when_present.click
          ...
          sleep 2
          browser.div(:id, "search-view").a(:href, "/artist/art.44043").when_present.click
 #         browser.li(:class, "typeahead-artist typeahead-top-result").when_present.click
          sleep 3
          browser.a(:href => "/artist/snoop-dogg/tracks").when_present.click
          sleep 1
          browser.div(:text, "Young, Wild & Free").when_present.hover
          sleep 2
