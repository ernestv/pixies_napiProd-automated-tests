...
#        sleep 10
        ...
        sleep 2
        browser.div(:id, "page-header").ul(:class, "content-tabbed-nav hero-tabs").a(:href => "/members/qahoferprod1").when_present.click
        sleep 2
      ...
      puts "Ubersicht"
        ...
        sleep 3
        browser.div(:text, "Metallica").when_present.click
#        browser.a(:href => "/artist/metallica").when_present.click
 #       browser.div(:class, "artist-grid-item grid-item").when_present.click
        sleep 2
        expect(browser.url).to include("lifestore-flat.at/artist")
        ...
        sleep 1
#        browser.a(:id => "ember2606").when_present.click #Tracks
        browser.a(:href => "/artist/metallica/similar-artists").when_present.click #Similar Artists
        sleep 1
        expect(browser.div(:class, "artist-grid ember-view")).to exist
        sleep 1

        browser.a(:href => "/artist/metallica/listeners").when_present.click #Listeners
        sleep 5
