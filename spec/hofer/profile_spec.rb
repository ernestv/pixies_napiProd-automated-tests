...
#        sleep 10
        ...
        sleep 2
        browser.div(:id, "page-header").ul(:class, "content-tabbed-nav hero-tabs").a(:href => "/members/LiveNoise14777").when_present.click
        sleep 2
...
#        expect(browser.div(:class, "profile-album-collage")).to exist
      ...
      puts "Ubersicht"
        ...
        sleep 1
        expect(browser.url).to include("lifestore-flat.at/artist/daft-punk")
...
#        browser.a(:href => "https://app.napster.com/artist/snoop-dogg/albums/main-releases").when_present.click #Similar Artists
        browser.a(:text, "Ähnliche Künstler").when_present.click #Similar Artists
        expect(browser.div(:class, "artist-grid ember-view")).to exist
        sleep 1

        browser.a(:text, "Hörer").when_present.click #Listeners
        sleep 5
