...
#      browser.a(:class, "button hide_for_mobile").when_present.click  # OLD BETA
      sleep 5
      ...
      sleep 15
        ...
        sleep 5
        browser.div(:text, "Water Under The Bridge").when_present.click
        sleep 5
