...
#      browser.a(:class, "button hide_for_mobile").when_present.click
      ...
      #            browser.div(:class, "icon-add_to_playlist add-to-sidebar-button").when_present.click
              ...
              context "Add LIBRARY to mixer" do
                ...
                sleep 2
                browser.div(:class, "library-artist scroll-content main-scroll").div(:class, "scroll-column").div(:class, "track-list-header delete-mode ember-view").div(:class, "options-button icon-details_bold").when_present.click
                sleep 2
                browser.span(:class => "icon-mixer_open icon").when_present.click
                sleep 2
              end
              ...
              it "Library tracks exist in mixer" do
                ...
                browser.div(:class, "sidebar-scroll")
                sleep 1
                expect(browser.div(:class, "sidebar-scroll").a(:href => "/artist/art.57934/album/alb.56580390/track/tra.56580417")).to exist
                sleep 2
              end
