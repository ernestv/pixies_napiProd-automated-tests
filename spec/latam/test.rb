...
#       browser.a(:id, "nav-signin").a(:href => '/login').when_present.click
      ...
      puts "Overview"
        ...
        sleep 2
        browser.ul(:class, "content-tabbed-nav hero-tabs").a(:text, "Mais ouvidos").when_present.click
        sleep 2
...
=begin
        ...
        sleep 1
=end
        browser.a(:href, "/artist/daft-punk/tracks").when_present.click #Tracks
        sleep 2
        ...
        browser.a(:href, "/artist/daft-punk/albums").when_present.click #Albums
        sleep 2
