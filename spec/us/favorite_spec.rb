...
#        expect(browser.url) .to include ("napster.com/login")
        ...
        sleep 2
        browser.div(:title, "More options").when_present.click
        sleep 1
...
#        sleep 6
      ...
      it "History" do
        ...
        sleep 5
        browser.div(:class, "track-info").when_present.hover #fire_event 'mouseover'
#        browser.div(:class, "ember-view track-list track-list contextual-track-list show-artist").div(:class, "track-info").when_present.hover
        sleep 5
        browser.div(:class, "options-button icon-options").when_present.click
        sleep 2
