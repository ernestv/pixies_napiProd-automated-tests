      ...
      describe "- ALBUM -" do
        ...
        describe "Horizontal player" do    
          it "logo" do
            ...
            it "sign in" do
              browser.iframe(:id, "horizontal-player").body(:class, " filter-supported").div(:id, "header").li(:class, "header-account").click
              browser.iframe(:id, "horizontal-player").div(:id, "modals").div(:class, "account-dialog dialog show").button(:id, "sign-in-button").click
...
#              expect(browser.url).to eq (RhapsodyUrl.get(:al,'/'))
            ...
            it "sign in" do
              browser.iframe(:id, "track-player").body(:class, " filter-supported").div(:id, "header").li(:class, "header-account").click
              browser.iframe(:id, "track-player").div(:id, "modals").div(:class, "account-dialog dialog show").button(:id, "sign-in-button").click
...
#              expect(browser.url).to eq ("https://app.lifestore-flat.de/login/?goto=/&redirect=1")
            ...
            it "sign in" do
              browser.iframe(:id, "square-player").body(:class, " filter-supported").li(:class, "header-account").click
              browser.iframe(:id, "square-player").div(:id, "modals").div(:class, "account-dialog dialog show").button(:id, "sign-in-button").click
...
#              expect(browser.url).to eq (RhapsodyUrl.get(:al,'/'))
            ...
            it "sign in" do
              browser.iframe(:id, "iab-rectangle-player").body(:class, " filter-supported").li(:class, "header-account").click
              browser.iframe(:id, "iab-rectangle-player").div(:id, "modals").div(:class, "account-dialog dialog show").button(:id, "sign-in-button").click
...
#              expect(browser.url).to eq ("https://app.lifestore-flat.de/login/?goto=/&redirect=1")
            ...
            it "sign in" do
              browser.iframe(:id, "iab-skyscraper-player").body(:class, " filter-supported").li(:class, "header-account").click
              browser.iframe(:id, "iab-skyscraper-player").div(:id, "modals").div(:class, "account-dialog dialog show").button(:id, "sign-in-button").click
